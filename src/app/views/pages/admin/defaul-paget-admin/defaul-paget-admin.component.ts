...
@Component({
  selector: 'app-defaul-paget-admin',
  templateUrl: './defaul-paget-admin.component.html',
  styleUrls: ['./defaul-paget-admin.component.scss']
})
export class DefaulPagetAdminComponent implements OnInit {
